    ...
    : "function" == typeof define && define.amd
      ...
      : (("undefined" != typeof window
          ...
          : "undefined" != typeof global
            ? global
            : "undefined" != typeof self ? self : this).dragula = e());
})(function() {
      ...
      2: [
        function(e, t, n) {
          (function(r) {
            ...
            function H(e, t, n) {
              var o = (e = e || {}).className || "";
              return (e.className += " gu-hide"), (n = R.elementFromPoint(
                t,
                n
              )), (e.className = o), n;
            }
            ...
            t.exports = function(e, t) {
              ...
              var i,
                g = null,
                y = t || {};
              void 0 === y.moves && (y.moves = $), void 0 === y.accepts &&
                (y.accepts = $), void 0 === y.invalid &&
                (y.invalid = function() {
                  return !1;
                }), void 0 === y.containers &&
                (y.containers = e || []), void 0 === y.isContainer &&
                (y.isContainer = V), void 0 === y.copy &&
                (y.copy = !1), void 0 === y.copySortSource &&
                (y.copySortSource = !1), void 0 === y.revertOnSpill &&
                (y.revertOnSpill = !1), void 0 === y.removeOnSpill &&
                (y.removeOnSpill = !1), void 0 === y.direction &&
                (y.direction = "vertical"), void 0 ===
                y.ignoreInputTextSelection &&
                (y.ignoreInputTextSelection = !0), void 0 ===
                y.mirrorContainer && (y.mirrorContainer = R.body);
              var w = M({
                ...
                if (i)
                  if (0 !== K(e)) {
                    if (
                      ...
                      (d = ee("pageX", e) - n.left), (m =
                        ee("pageY", e) - n.top), j.add(
                        h || s,
                        "gu-transit"
                      ), (function() {
                        if (l) return;
                        var e = s.getBoundingClientRect();
                        ((l = s.cloneNode(!0)).style.width =
                          G(e) + "px"), (l.style.height = J(e) + "px"), j.rm(
                          l,
                          "gu-transit"
                        ), j.add(l, "gu-mirror"), y.mirrorContainer.appendChild(
                          l
                        ), U(q, "add", "mousemove", P), j.add(
                          y.mirrorContainer,
                          "gu-unselectable"
              ...
              function C(e) {
                var t, n;
                (t = e.item), (n = e.source), ("boolean" == typeof y.copy
                  ? y.copy
                  : y.copy(t, n)) &&
                  (
                    (h = e.item.cloneNode(!0)),
                    w.emit("cloned", h, e.item, "copy")
                  ), (f = e.source), (s = e.item), (v = p = Z(
                  e.item
                )), (w.dragging = !0), w.emit("drag", s, f);
              }
              function O() {
                var e;
              ...
              function _(e, t) {
                var n = Q(e);
                h && y.copySortSource && t === f && n.removeChild(s), A(t)
                  ? w.emit("cancel", e, f, f)
                  : w.emit("drop", e, t, f, p), Y();
              }
              function X() {
                var e, t;
                w.dragging &&
              ...
              function Y() {
                ...
                I(), l &&
                  (
                    ...
                    Q(l).removeChild(l),
                    (l = null)
                  ), e && j.rm(e, "gu-transit"), n &&
                  clearTimeout(n), (w.dragging = !1), g &&
                  w.emit("out", e, g, f), w.emit(
                  "dragend",
                  e
                ), (f = s = h = v = p = n = g = null);
              }
                      ...
                      var o =
                        ...
                        (function(n, o) {
                          return function(e) {
                            var t = e || r.event;
                            (t.target =
                              t.target || t.srcElement), (t.preventDefault =
                              t.preventDefault ||
                              function() {
                                t.returnValue = !1;
                              }), (t.stopPropagation =
                              ...
                              function() {
                                t.cancelBubble = !0;
                              }), (t.which = t.which || t.keyCode), o.call(
                              n,
                              t
                            );
                          };
              ...
              : "undefined" != typeof document &&
                ...
                ? function(e, t) {
                    ...
                    return t
                      ...
                      : n.initCustomEvent(e, !1, !1, void 0), n;
                  }
                : function(e, t) {
      ...
      9: [
        function(e, t, n) {
          ...
          (t.nextTick = function(e) {
            ...
            "browser"), (t.browser = !0), (t.env = {}), (t.argv = []), (t.version =
            ""), (t.versions = {}), (t.on = p), (t.addListener = p), (t.once = p), (t.off = p), (t.removeListener = p), (t.removeAllListeners = p), (t.emit = p), (t.prependListener = p), (t.prependOnceListener = p), (t.listeners = function(
            e
          ) {
            return [];
